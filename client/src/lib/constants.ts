export const VIBES = [
  {
    ...
    description: "Chronically online, knows every trend, speaks in stan twitter. Explains sports using pop culture, celebrity, and internet metaphors. Turns plays into storylines, eras, and iconic moments. Great if you want sports explained in a fun, relatable way.",
  ...
  },
  {
    ...
    description: "Charismatic and meme-heavy, Explains sports like everything is effortless and elite. Big plays aren’t surprising, they’re expected. Every move has swagger, every win is inevitable. Perfect if you want hype without chaos.",
  ...
  },
  {
    ...
    description: "Supportive, chaotic, uses way too many emojis and caps. Explains sports like you’re watching with your friends who barely know the rules but are VERY loud about it. Reacts first, explains second, and makes every moment feel personal.",
